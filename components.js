(function(){
  ...
  style.textContent = [
    ...
    "#hs-footer{background:#0a0a0a;padding:28px 24px;border-top:1px solid #1e1e1e;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px}",
    "#hs-footer .hs-footer-logo{font-family:var(--hs-serif);font-size:16px;color:#555}",
    "#hs-footer .hs-footer-logo em{font-style:italic;color:#f0a0c0}",
    "#hs-footer .hs-footer-links{display:flex;gap:16px;flex-wrap:wrap}",
    "#hs-footer .hs-footer-links a{font-size:13px;color:#555;text-decoration:none;transition:color 0.15s}",
    "#hs-footer .hs-footer-links a:hover{color:#aaa}",
  ...
  footer.innerHTML =
    ...
    '<div class="hs-footer-links">' +
      ...
      '<a href="tel:+393924076794">+39 392 407 6794</a>' +
    '</div>';
