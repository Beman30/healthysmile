// Healthy Smile - Teamup preview. Source commit: 0a6ab486cff47b3a80a48731510e29e7cb0eb121. Build: esbuild 0.25.9.
var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });

// teamup-bundle/src/teamup.js
...
async function read(env, resource, params, fetcher) {
  ...
  try {
    ...
    throw new Error("Lettura Teamup non riuscita. Verificare chiave API, accesso al calendario e disponibilit\xE0 del servizio.");
  } finally {
    clearTimeout(timer);
  }
}
