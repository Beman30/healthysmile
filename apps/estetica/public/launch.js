...
(async()=>{
 ...
 const scripts=["app.js?v=24", "workflow.js?v=26", "cloud.js?v=2", "presentation.js?v=26", "device.js?v=1", "alignment.js?v=17", "brightness.js?v=15", "position.js?v=31", "reference-contour.js?v=19", "patient-guidance.js?v=31", "before-guide.js?v=23", "zone-guide.js?v=30", "after-burst.js?v=24", "sharing.js?v=15", "responsive.js?v=2", "capture-screen.js?v=30", "install.js?v=4", "auth-ui.js?v=1"];
 try{
