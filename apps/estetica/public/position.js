...
function cameraMatchState(reference,track){
 ...
 return {text:'stesso obiettivo',warning:false,detail:'Mantieni la distanza dal paziente. Sovrapponi occhi, naso e mento muovendo il supporto, senza cambiare zoom.'};
}
function paintCapturePosition(){
 ...
 $('matchPoseHint').textContent=ref?'Prima regola la livella. Poi alza o abbassa il supporto e ritrova occhi, naso e mento in trasparenza. Ripeti rotazione della testa ed espressione.':'Lente all’altezza degli occhi, testa naturale. Alza o abbassa il supporto senza inclinare il telefono.';
 ...
 $('matchCameraHint').textContent=camera.detail||'Usa la fotocamera posteriore principale e mantieni lo stesso zoom e distanza. La sagoma non misura la distanza.';
